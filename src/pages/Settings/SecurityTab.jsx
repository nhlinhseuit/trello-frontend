...
function SecurityTab() {
  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      ...
      .then(() => {
        // Lay cac key cua cac field input ma chung ta register ben duoi
        ...
        toast.promise(
          ...
          // Kiem tra kh co loi (update thanh cong) thi cho login agin
          if (!res.error) {
            toast.success('Your password is updated successfully, please login again!')
